...
export default function MobileLayout({ slicer }: Props) {
  ...
  return (
    <main style={{ minHeight: 0, display: "grid", gridTemplateRows: activePane ? "minmax(180px, 1fr) minmax(72px, 45dvh) 58px" : "minmax(0, 1fr) 58px", overflow: "hidden", padding: "6px 6px max(6px, env(safe-area-inset-bottom))", gap: "6px", boxSizing: "border-box" }}>
